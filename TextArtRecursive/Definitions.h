...
const char mainMenu[] = "<E>dit / <M>ove / <R>eplace / <D>raw / <C>lear / <U>ndo / <L>oad / <S>ave / <Q>uit:";
const int MAINSCREENLENGTH = 23;
const int MAINSCREENWIDTH = strnlen(mainMenu, 100) + 15;

const char altMenu1[] = "<A>nimate: N / <F>ill / <L>ine / <B>ox / <N>ested Boxes / <T>ree / <M>ain Menu:";
const char altMenu2[] = "<A>nimate: Y / <F>ill / <L>ine / <B>ox / <N>ested Boxes / <T>ree / <M>ain Menu:";

const int ALTSCREENLENGTH = 23;
const int ALTSCREENWIDTH = strnlen(altMenu1, 100) + 15;

// Used for readability in menuTwo function
const int INVALID = -1 ;
...
/*
* Used to validate the user-entered data
* Takes a character array as paramater to display correct message
* Takes the screen length and width to know how many lines to clear
* Clears the line and displays the character array as long as input isnt valid
* Returns the correct value entered by user
*/
int dataValidation(const char message[], int screenLength, int screenWidth) ;


/*
* Takes in point as parameter (VS complained at me if I didnt pass by reference)
* Checks to see if the row and column are valid entries from the user 
* If the point has invalid entries, swaps the the new character to the old character
...
/*
* Takes in a point as parameter (VS complained at me if I didnt pass by reference)
* Takes in a character as parameter to determine if the point should be centered
* Changes point row and column to middle cell if C is passed into it
* returns true if it was a centered point
*/
bool checkForCenter(Point& pointToCheck, char checkForC);

/*
* Takes a character array as parameter
* Outputs contents of character array
* Used for programming readability 
*/
...
/*
* Takes the canvas and user-entered variables as paramters
* Determines what function to proceed with based off of the input from the user
* Used to keep the main function clean and readable
*/
...
/*
* Prints menu that is passed through to the screen
*/
